pub mod user{
    pub mod login_user {
        ...
        pub fn handle(user_credentials: &LoginUser) -> Result<bool, &'static str> {
            Ok(user_credentials.remember_me.unwrap_or(false))
        }
        ...
        mod tests {
            ...
            // #[test]
            // fn login_user_should_return_true() {
            //     let user_credentials = LoginUser{
            //         username: "test".to_string(),
            //         password: "test".to_string(),
            //         remember_me: None,
            //     };

            //     assert_eq!(handle(&user_credentials), Ok(true));
            // }
        }
    }
